...
class LanguageTest < Test::Unit::TestCase
	...
	# 	assert_equal(true, execute("
	# 		mod int i = 0;
	# 		def bool check_limit(mod int a){ if(a >= 5){ 1+2; return false; 3+4; } if(a < 5){ 1+2; return true; 3+4;}}
	# 		check_limit(2);
	#   	"))
	...
	def test_array_arithmetics
		...
		assert_equal([true,true,true], execute("int[] arr_a = [1,2,3]; int[] arr_b = [1,2,3]; arr_a > arr_b;"))
		assert_equal([1,2,3,1,2,3], execute("int[] arr_a = [1,2,3]; int[] arr_b = [1,2,3]; arr_a >= arr_b;"))
		assert_equal([1,2,3,1,2,3], execute("int[] arr_a = [1,2,3]; int[] arr_b = [1,2,3]; arr_a <= arr_b;"))
		assert_equal([1,2,3,1,2,3], execute("int[] arr_a = [1,2,3]; int[] arr_b = [1,2,3]; arr_a != arr_b;"))
		assert_equal([1,2,3,1,2,3], execute("int[] arr_a = [1,2,3]; int[] arr_b = [1,2,3]; arr_a == arr_b;"))
		assert_equal([1,2,3,1,2,3], execute("int[] arr_a = [1,2,3]; int[] arr_b = [1,2,3]; arr_a && arr_b;"))
